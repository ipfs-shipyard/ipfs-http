...
func (a *FilesApiService) FilesCreate(ctx context.Context, path string, localVarOptionals *FilesCreateOpts) (*http.Response, error) {
	var (
...
func (a *FilesApiService) FilesGet(ctx context.Context, path string, localVarOptionals *FilesGetOpts) (UnixfsEntry, *http.Response, error) {
	var (
 ...
 * @param optional nil or *FilesRemoveOpts - Optional Parameters:
 * @param "Recursive" (optional.Bool) -  Remove directories recursively
*/

type FilesRemoveOpts struct {
    Recursive optional.Bool
}

func (a *FilesApiService) FilesRemove(ctx context.Context, path string, localVarOptionals *FilesRemoveOpts) (*http.Response, error) {
	var (
 ...
 * @param optional nil or *FilesReplaceOpts - Optional Parameters:
 * @param "Parents" (optional.Bool) -  Make parent directories as needed
 * @param "RawLeaves" (optional.Bool) -  Use raw blocks for newly created leaf nodes
 * @param "HashAlg" (optional.String) - 
 * @param "CidVersion" (optional.Int32) -  Which CID version to use
...
func (a *FilesApiService) FilesReplace(ctx context.Context, path string, localVarOptionals *FilesReplaceOpts) (*http.Response, error) {
	var (
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param path The MFS path you wish to update
 * @param optional nil or *FilesUpdateOpts - Optional Parameters:
 * @param "Offset" (optional.Int32) -  Byte offset to begin writing at
 * @param "Parents" (optional.Bool) -  Make parent directories as needed
...
func (a *FilesApiService) FilesUpdate(ctx context.Context, path string, localVarOptionals *FilesUpdateOpts) (*http.Response, error) {
	var (
